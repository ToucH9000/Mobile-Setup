...
Kernel : [LineageKSU](https://github.com/chiteroman/kernel_vayu_lineage/releases) -  [Also Prefer [RectiliaKSU](https://github.com/chiteroman/kernel_vayu_rectilia/releases)]<br>
